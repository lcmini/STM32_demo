...
int main(void)
{
  ...
  while (1)
  {
    ...
    printf("ADC的模拟量是%4d\n",ADC_Value);
		...
		LCD_ShowNum(3,4,AX,5,16);
		LCD_ShowNum(60,4,AY,5,16);
		LCD_ShowNum(3,20,AZ,5,16);
		LCD_ShowNum(60,20,GX,5,16);
		LCD_ShowNum(3,40,GY,5,16);
		LCD_ShowNum(60,40,GZ,5,16);
		LCD_ShowNum(3,60,LX,5,16);
