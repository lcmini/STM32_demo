...
/*
	...
	LCD_CS:		PA6
*/
#define	LCD_PWR		HAL_GPIO_WritePin(GPIOA,GPIO_PIN_2,GPIO_PIN_SET)//PAout(2)
#define	LCD_RST		HAL_GPIO_WritePin(GPIOA,GPIO_PIN_3,GPIO_PIN_SET)//PAout(3)
#define	LCD_WR		HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_SET)//PAout(4)
#define	LCD_CS		HAL_GPIO_WritePin(GPIOA,GPIO_PIN_6,GPIO_PIN_SET)//PAout(6)
